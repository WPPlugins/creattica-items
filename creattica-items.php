...
if (class_exists('WP_Widget')) 
{
  class Creattica_Images_Widget extends WP_Widget 
  {
    ...
    function widget($args, $instance) 
    {
  		...
  		if ( !empty( $subtitle ) ) { 
  		  $before_subtitle = ($before_subtitle) ? $before_subtitle : '<span class="subtitle">';
  		  $after_subtitle = ($after_subtitle) ? $after_subtitle : '</span>';
    ...
    {
  		$instance = wp_parse_args( (array) $instance, array( 'title' => '', 'subtitle' => '', 'items' => '', 'url' => '' ) );
      ...
      ?>	
  		...
  		<p>
  		  <label for="<?php echo $this->get_field_id('subtitle'); ?>">Subtitle: 
  		    <input class="widefat" id="<?php echo $this->get_field_id('subtitle'); ?>" name="<?php echo $this->get_field_name('subtitle'); ?>" type="text" value="<?php echo attribute_escape($subtitle); ?>" />
  		  </label>
  		</p>
  		<p>
